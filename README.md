...
- **Navigate a field's ancestry** from a clickable, scrollable, keyboard-navigable hover breadcrumb in Live Preview, Source, or Reading mode, with independent full-field, full-key, and icon/expansion-toggle activation scopes plus optional full-name wrapping.
